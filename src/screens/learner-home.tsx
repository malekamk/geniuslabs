...
import { countdown } from '@/app/(tabs)/classes';
        ...
        <View style={{ maxWidth: MaxContentWidth, alignSelf: 'center', width: '100%' }}>
          ...
          <View style={styles.section}>
            ...
            {upcomingClasses.length > 0 ? (
              ...
              <EmptyState illustration={ScheduleIllustration} title="No classes scheduled" sub="Check back soon — new classes will appear here." />
            )}
          </View>
          ...
          <View style={styles.section}>
            ...
            {quizzes.length > 0 ? (
              ...
              <EmptyState illustration={ExamsIllustration} title="No quizzes yet" sub="Published quizzes for your grade will show up here." />
            )}
          </View>
          ...
          <View style={styles.section}>
            ...
            {latest.length > 0 ? (
              ...
              <EmptyState illustration={AnnouncementIllustration} title="No announcements" sub="School updates and news will appear here." />
            )}
          </View>
...
const styles = StyleSheet.create({
  ...
  greetText: { fontSize: 18, color: '#000', fontWeight: '500' },
  nameText: { fontSize: 28, fontWeight: '900', color: '#111827' },
  bellBtn: {
